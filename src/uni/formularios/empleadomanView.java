...
public class empleadomanView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtIdEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        if (tblEmpleado.getColumnModel().getColumnCount() > 0) {
            ...
            tblEmpleado.getColumnModel().getColumn(3).setPreferredWidth(160);
        }
    ...
    private void procesar(int opcion) {
        ...
        try {
            switch (opcion) {
                ...
                case 2:
                    leerDatos();
                    obj.EmpleadoActualizar(emp);
                    msg = "Empleado actualizado con exito";
                    break;
                case 3:
                    leerDatos();
                    obj.EmpleadoEliminar(emp);
